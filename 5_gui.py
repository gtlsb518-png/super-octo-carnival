...
class App:
    ...
    def add_coin_dialog(self):
        ...
        tp_sideways_var = tk.DoubleVar(value=1.2)  # ✅ 1.2% (횡보장)
    ...
    def edit_settings(self, coin):
        ...
        tp_sideways_var = tk.DoubleVar(value=coin.get('tp_sideways', 1.2))  # ✅ 기본값 1.2%
                        ...
                        try:
                            ...
                            if df_full is not None and len(df_full) >= 50:
                                ...
                                if adx_value >= 21:
                                    ...
                                    dynamic_tp = coin.get('tp_sideways', 1.2)  # ✅ 1.2%
                                    market_type = '횡보장'
                ...
                if 'adx_canvas' in coin:
                    try:
                        ...
                        if adx_value >= 21:
                            ...
                            market_type = '횡보장'
                            market_color = '#ffaa00'
                            current_tp = coin.get('tp_sideways', 1.2)  # ✅ 1.2%
