...
- **진입**: UT Bot 상태 + EMA(34/55) 크로스 AND 조건, 코인당 LONG/SHORT 봇 각 1개
- **익절**: ADX(기간 10) 기반 동적 TP — 추세장(ADX≥21) 1.5% / 횡보장 1.0%
- **손절**: ROI -50% 도달 시 청산 후 쿨다운(신호 2개 충족 시 재진입)
- **스위칭**: 보유 중 역신호 발생 시 청산 후 즉시 반대 방향 진입
