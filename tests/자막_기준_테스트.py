...
GOLD_RULES = [
    ...
    ("걸어놓고 120일선 58만 원 문 앞이야",
     ["걸어놓고 120일선", "58만원 문 앞이야"]),
    ("주주들은 이제 150만 원 박스 뚫는 거 팔짱 끼고 편하게 보면 돼",
     ["주주들은 이제 150만원", "박스 뚫는 거", "팔짱 끼고 편하게 보면 돼"]),
    # 세는 말('석 달')을 떼지 않기
    ("6월에 242만 원 찍고 석 달 동안 150만 원 박스에 갇혀서",
     ["6월에 242만원 찍고", "석 달 동안 150만원", "박스에 갇혀서"]),
...
# 금액: 만 원 단위면 '4만원', 천 원 단위가 있으면 '12,000원' (사용자 요청)
GOLD_MONEY = [
    ("지금 10만 원인데", "지금 10만원인데"),
    ("1차 매물대 7만 원만", "1차 매물대 7만원만"),
